...
$out['ready']=$out['active_loop_segments']===9&&$out['ready_observables']===3&&
 $out['measurement_required']===6&&$out['executable_equations']===1&&
 $out['parameter_gated_equations']===5&&$out['persistence_loop_structurally_complete']===1;
